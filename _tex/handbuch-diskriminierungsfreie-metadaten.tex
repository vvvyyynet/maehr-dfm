...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, opacitybacktitle=0.6, toprule=.15mm, left=2mm, opacityback=0, breakable, rightrule=.15mm, bottomrule=.15mm, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, leftrule=.75mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, opacitybacktitle=0.6, toprule=.15mm, left=2mm, opacityback=0, breakable, rightrule=.15mm, bottomrule=.15mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, leftrule=.75mm, colback=white]
