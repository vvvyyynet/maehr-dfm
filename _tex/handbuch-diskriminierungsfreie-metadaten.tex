...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, left=2mm, coltitle=black, leftrule=.75mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, colback=white, toprule=.15mm, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, breakable, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, opacitybacktitle=0.6]
