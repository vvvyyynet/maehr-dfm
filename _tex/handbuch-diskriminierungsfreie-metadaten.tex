...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, colback=white, breakable, toptitle=1mm, leftrule=.75mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, opacityback=0, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, bottomrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, colback=white, breakable, toptitle=1mm, leftrule=.75mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, bottomrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, colback=white, breakable, toptitle=1mm, leftrule=.75mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, bottomrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6]
